controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    if (mySprite.image.equals(assets.image`tank 4`)) {
        projectile = sprites.createProjectileFromSprite(img`
            ...
            . . . . . . . . . . . . . . . . 
            `, mySprite, 0, -100)
    } else if (mySprite.image.equals(assets.image`tank 0`)) {
        projectile = sprites.createProjectileFromSprite(img`
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            ...
            . . . . . . . . . . . . . . . . 
            `, mySprite, 100, 0)
    } else if (mySprite.image.equals(assets.image`tank 3`)) {
        projectile = sprites.createProjectileFromSprite(img`
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
...
game.onUpdate(function () {
    if (controller.right.isPressed()) {
        mySprite.setImage(assets.image`tank 0`)
    }
    if (controller.left.isPressed()) {
        mySprite.setImage(assets.image`tank 2`)
    }
    if (controller.down.isPressed()) {
        mySprite.setImage(assets.image`tank 3`)
    }
    if (controller.up.isPressed()) {
        mySprite.setImage(assets.image`tank 4`)
    }
})
